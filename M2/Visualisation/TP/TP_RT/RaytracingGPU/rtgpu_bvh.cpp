...
class RTViewer: public GLViewer
{
	...
	GLVec3 light_position2;
	GLVec3 light_position3;
	float light_power;
	float k_opa;
	float Ks, Kd, Ka;
	int nb_shadows;
...
RTViewer::RTViewer() :
	...
	light_position2(20, 10, 60),
	light_position3(10, 20, 60),
	light_power(1.0f),
	Ks(0.3f),
	Kd(0.3f),
	Ka(0.3f),
...
void RTViewer::draw_ogl()
{
	...
	if (draw_rt_)
	{
		...
		set_uniform_value(22, light_position2);
		set_uniform_value(23, light_position3);
		// set_uniform_value(24, Ka);
...
//		ImGui::SliderFloat("LightPower", &light_power, 0.5, 1.5);
	...
	ImGui::SliderFloat("Light position x: ", &light_position[0], -100.0f, 100.0f);
	ImGui::SliderFloat("Light position y: ", &light_position[1], -100.0f, 100.0f);
	ImGui::SliderFloat("Light position z: ", &light_position[2], -100.0f, 100.0f);
	ImGui::End();
}
